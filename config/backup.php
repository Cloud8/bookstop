...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                /*
                 * Files backup is disabled — we back up only the database.
                 * The 'files' key must be present for the package to boot correctly.
                 */
                'include' => [],
                'exclude' => [],
                'follow_links' => false,
        ...
        'destination' => [
            ...
            /*
             * The path prefix used inside the destination disk.
             */
            'path' => 'backups',
