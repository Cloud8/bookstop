                ...
                <div class="bg-white border border-border-subtle rounded-xl p-6 sticky top-6">
                    ...
                    <div class="border-t border-border-subtle pt-4 mb-6 flex justify-between items-baseline">
                        ...
                        <span class="font-serif text-xl font-semibold text-text-primary">
                            {{ number_format($total / 100, config('shop.currency_decimals'), config('shop.currency_decimal_sep'), ' ') }}&nbsp;{{ config('shop.currency_symbol') }}
                        </span>
                    </div>
                                    ...
                                    @foreach($paymentProviders as $providerSlug)
                                        ...
                                        >
                                            ...
                                            @if($providerSlug === 'paypal')
                                                ...
                                                <button
                                                    type="submit"
                                                    class="w-full flex items-center justify-center px-5 py-3 rounded-lg transition hover:brightness-95 active:brightness-90"
                                                    style="background-color:#FFC439;"
                                                    aria-label="Оплатить через PayPal"
                                                >
                                                    <svg height="22" viewBox="0 0 124 33" xmlns="http://www.w3.org/2000/svg">
