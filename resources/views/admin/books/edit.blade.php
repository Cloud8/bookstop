        ...
        <div class="bg-surface border border-border-subtle rounded-xl divide-y divide-border-subtle">
            ...
            <div class="p-6 space-y-5">
                ...
                <div>
                    ...
                    @if ($book->epub_path)
                        <div class="mb-3 flex items-center gap-2 px-3 py-2 bg-surface-muted border border-border-subtle rounded-lg">
                            ...
                            <span class="text-xs text-text-primary font-medium">Файл загружен</span>
                            <span class="text-xs text-text-subtle">— загрузите новый файл, чтобы заменить</span>
                        </div>
                    @endif
                    <input
                        id="epub"
