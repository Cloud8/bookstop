...
class BookFileUploadService
{
    ...
    /**
     * Stream a local file to S3 private disk and return the stored path.
     *
    ...
    /**
     * Create or reset the source BookFile record, deleting the old S3 file if present.
     */
